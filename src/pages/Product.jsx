...
const Product = () => {
  ...
  const fetchProductData = async () => {
    products.map((item) => {
      if (item._id === productId || String(item.id) === productId) {
        setProductData(item)
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex items-center gap-1 mt-2'>
            {[1, 2, 3, 4].map((i) => (
              <svg key={i} className='w-3.5' viewBox="0 0 24 24" fill="orange" stroke="orange" strokeWidth="1">
                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
              </svg>
            ))}
            <svg className='w-3.5' viewBox="0 0 24 24" fill="none" stroke="orange" strokeWidth="1">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
            </svg>
